...
app.post('/api/check-writing', async (req, res) => {
  try {
    ...
    const [grammarCheck, aiAssessmentQuery, grammarRulesQuery, writingTipsQuery] = await Promise.all([
   ...
   const grammarCheckResponse = grammarCheck.choices[0].message.content;
   ...
   console.log("\nAPI Response #2.1 (Grammar/Spelling Check):");
   ...
   try {
    ...
    const result = {
      ...
      essayReview: grammarCheckResponse,
